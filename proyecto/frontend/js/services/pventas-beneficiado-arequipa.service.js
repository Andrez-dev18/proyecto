class PVentasBeneficiadoArequipaService {
    constructor() {
        this.config = PVentasBeneficiadoArequipaConfig;
    }
    ...
    limpiarDatos(data) {
        ...
        const camposNumericos = [
            'grs', 'rp', 'avicola_renzo', 'avelino', 'peladores', 'avicruz',
...
window.PVentasBeneficiadoArequipaService = PVentasBeneficiadoArequipaService;
