class TipoHuevoController {
    constructor() {
        this.service = new TipoHuevoService();
        this.registroSeleccionado = null;
        this.datos = [];
        this.config = window.TipoHuevoConfig;
        this.dataTable = null;
        this.columnasVisibles = {};
    }

    async init() {
        console.log('🚀 Inicializando Tipo Huevo Controller...');
    ...
    mostrarModalNuevo() {
        this.registroSeleccionado = null;
        document.getElementById('modalTitle').textContent = 'Nuevo Tipo de Huevo';
    ...
    modificarSeleccionado() {
        ...
        document.getElementById('modalTitle').textContent = 'Modificar Tipo de Huevo';
    ...
    validarFormulario(data) {
        if (!data.nombre) {
            this.mostrarNotificacion('El nombre del tipo de huevo es obligatorio', 'warning');
            return false;
        }
        return true;
    }
...
window.tipoHuevoController = new TipoHuevoController();
