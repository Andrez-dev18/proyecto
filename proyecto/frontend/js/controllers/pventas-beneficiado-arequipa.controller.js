class PVentasBeneficiadoArequipaController {
    constructor() {
        this.service = new PVentasBeneficiadoArequipaService();
        ...
        this.columnas = [
            ...
            { nombre: 'Avelino', campo: 'avelino', visible: false },
            { nombre: 'Peladores', campo: 'peladores', visible: false },
            { nombre: 'Avicruz', campo: 'avicruz', visible: false },
            { nombre: 'Rafael', campo: 'rafael', visible: false },
            { nombre: 'Matilde', campo: 'matilde', visible: false },
            { nombre: 'Avirox', campo: 'avirox', visible: false },
            { nombre: 'Julia', campo: 'julia', visible: false },
            { nombre: 'Simon', campo: 'simon', visible: false },
            { nombre: 'Yesica', campo: 'yesica', visible: false },
            { nombre: 'Gabriel', campo: 'gabriel', visible: false },
            { nombre: 'Arturo', campo: 'arturo', visible: false },
            { nombre: 'Nicolas', campo: 'nicolas', visible: false },
            { nombre: 'Luis F', campo: 'luis_f', visible: false },
            { nombre: 'Mirella', campo: 'mirella', visible: false },
        ...
        this.dataTablesConfig = PVentasBeneficiadoArequipaConfig.UI.DATATABLES_LANGUAGE;
    }

    async init() {
        console.log('🚀 Inicializando PVentasBeneficiadoArequipa Controller...');
    ...
    renderizarTablaCliente() {
        ...
        const columnsConfig = this.columnas.map((col, index) => ({
            ...
            className: col.campo.includes('potencial') || col.campo.includes('grs') || col.campo.includes('rp') || 
                       col.campo.includes('avicola_renzo') || col.campo.includes('avelino') || col.campo.includes('peladores') || 
                       col.campo.includes('avicruz') || col.campo.includes('rafael') || col.campo.includes('matilde') ||
                       col.campo.includes('avirox') || col.campo.includes('julia') || col.campo.includes('simon') ||
                       col.campo.includes('yesica') || col.campo.includes('gabriel') || col.campo.includes('arturo') ||
                       col.campo.includes('nicolas') || col.campo.includes('luis_f') || col.campo.includes('mirella') ||
                       col.campo.includes('otros')
    ...
    cargarDatosEnFormulario() {
        ...
        setValue('modalAvelino', r.avelino);
        setValue('modalPeladores', r.peladores);
        setValue('modalAvicruz', r.avicruz);
        setValue('modalRafael', r.rafael);
        setValue('modalMatilde', r.matilde);
        setValue('modalAvirox', r.avirox);
        setValue('modalJulia', r.julia);
        setValue('modalSimon', r.simon);
        setValue('modalYesica', r.yesica);
        setValue('modalGabriel', r.gabriel);
        setValue('modalArturo', r.arturo);
        setValue('modalNicolas', r.nicolas);
        setValue('modalLuisF', r.luis_f);
        setValue('modalMirella', r.mirella);
    ...
    obtenerDatosFormulario() {
        ...
        const data = {
            ...
            avelino: getIntValue('modalAvelino'),
            peladores: getIntValue('modalPeladores'),
            avicruz: getIntValue('modalAvicruz'),
            rafael: getIntValue('modalRafael'),
            matilde: getIntValue('modalMatilde'),
            avirox: getIntValue('modalAvirox'),
            julia: getIntValue('modalJulia'),
            simon: getIntValue('modalSimon'),
            yesica: getIntValue('modalYesica'),
            gabriel: getIntValue('modalGabriel'),
            arturo: getIntValue('modalArturo'),
            nicolas: getIntValue('modalNicolas'),
            luis_f: getIntValue('modalLuisF'),
            mirella: getIntValue('modalMirella'),
...
window.pventasBeneficiadoArequipaController = new PVentasBeneficiadoArequipaController();
