<?php
require_once __DIR__ . '/../services/OficialGRSService.php';

class OficialGRSController
{
    ...
    {
        $this->service = new OficialGRSService($db);
    }
    ...
    public function autocomplete()
    {
        ...
        $resultados = $this->service->autocomplete($campo, $query);

        // Retornar solo lista simple
        $lista = array_map(function ($row) use ($campo) {
            return $row[$campo];
        }, $resultados);
