...
class TipoProdSustitutoService
{
    ...
    public function save($data)
    {
        ...
        $this->historialService->logAction("INSERTAR", "com_tip_prod_sut", $id, null, $data, "registro creado");
        return $id;
    }
    ...
    public function update($data)
    {
        ...
        $this->historialService->logAction("ACTUALIZAR", "com_tip_prod_sut", $id, $previos, $data, "registro actualizado");
        return $id;
    }
    ...
    public function delete($id)
    {
        ...
        if($deletedRows > 0){
            $this->historialService->logAction("ELIMINAR", "com_tip_prod_sut", $id, $previos, null, "registro ELIMINADO");
        }
