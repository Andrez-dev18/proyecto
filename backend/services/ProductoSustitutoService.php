...
class ProductoSustitutoService
{
     ...
     public function save($data)
    {
        ...
        $this->historialService->logAction("INSERTAR", "com_db_prod_sustituto", $id, null, $data, "registro creado");
        return $id;
    }
    ...
    public function update($data)
    {
        ...
        $this->historialService->logAction("ACTUALIZAR", "com_db_prod_sustituto", $id, $previos, $data, "registro actualizado");
        return $id;
    }
    ...
    public function delete($id)
    {
        ...
        if($deletedRows > 0){
            $this->historialService->logAction("ELIMINAR", "com_db_prod_sustituto", $id, $previos, null, "registro ELIMINADO");
        }
