...
class VendedorService
{
    ...
    public function save($data)
    {
        ...
        $this->historialService->logAction("INSERTAR", "com_vendedor", $id, null, $data, "registro creado");
        return $id;
    }
    ...
    public function update($data)
    {
        ...
        $this->historialService->logAction("ACTUALIZAR", "com_vendedor", $data['id'], $previos, $data, "registro actualizado");
        return $data['id'];
    }
    ...
    public function delete($id)
    {
        ...
        if($deletedRows > 0){
            $this->historialService->logAction("ELIMINAR", "com_vendedor", $id, $previos, null, "registro ELIMINADO");
        }
