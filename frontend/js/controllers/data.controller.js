class DataController {
    ...
    async eliminarRegistro() {
        const registro = this.obtenerRegistroSeleccionado();
        
        if (!registro) {
            uiController.mostrarAlerta(AppConfig.MENSAJES.ERROR.SELECCIONAR_REGISTRO);
            return;
        }
        ...
        try {
            uiController.mostrarCargando(true);
            await apiService.eliminar(this.tipoActual, registro.id);
