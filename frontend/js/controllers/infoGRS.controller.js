class InfoGRSController {
    ...
    obtenerDatosFormulario() {
        return {
            ...
            peso_prom: parseFloat(document.getElementById("modalPeso_prom").value) || 0,
            mercado: parseFloat(document.getElementById("modalMercado").value) || 0
        };
    }
    ...
    renderizarTablaFiltrada() {
        ...
        const columnas = [
            "id", "fecha",
            "provincia", "zona", "tipo", "categoria",
            "linea", "codigo", "descripcion", "cantidad",
            "precio", "peso", "importe", "peso_prom",
            "mercado",
        ];
    ...
    cargarDatosEnFormulario() {
        ...
        document.getElementById("modalPeso_prom").value = r.peso_prom || "";
...
window.infoGRSController = new InfoGRSController();