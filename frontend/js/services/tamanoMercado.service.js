class TamanoMercadoService {
    ...
    async crear(data) {
        try {
            const response = await fetch(`${this.baseURL + AppConfig.API.ENDPOINTS.TAMAMERDIA.CREAR}`, {
                method: 'POST',
    ...
    async actualizar(data) {
        try {
            const url = `${this.baseURL + AppConfig.API.ENDPOINTS.TAMAMERDIA.EDITAR}`;
    ...
    async eliminar(id) {
        try {
            const url = `${this.baseURL + AppConfig.API.ENDPOINTS.TAMAMERDIA.BORRAR}/${id}`;
    ...
    async filtrar(filtros) {
        try {
            ...
            const url = `${this.baseURL + AppConfig.API.ENDPOINTS.TAMAMERDIA.FILTRO}${params}`;
    ...
    async exportarCSV() {
        try {     console.log(`${this.baseURL + AppConfig.API.ENDPOINTS.TAMAMERDIA.EXPORTA}`, '_blank');
            // Abrir en nueva pestaña para descargar
            window.open(`${this.baseURL + AppConfig.API.ENDPOINTS.TAMAMERDIA.EXPORTA}`,'_blank');
